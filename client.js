...
function appendInfo() {
    ...
    let infoString = $(`<tr><td>${firstName}</td><td>${lastName}</td><td class="employeeID">${id}</td><td>${title}</td><td>$${salaryCommas}</td><td><button class="delete btn-danger">Delete</button></td></tr>`);
